...
// MARK: - Current schema (V2)

/// Current schema. Adds `Disc.radius` and `ThrowData.launchAngle` over V1.
...
typealias Disc = SchemaV2.Disc
typealias ThrowData = SchemaV2.ThrowData
...
enum OpenDiscMigrationPlan: SchemaMigrationPlan {
    ...
    static var stages: [MigrationStage] {
        // V1 -> V2 is purely additive (Disc.radius, ThrowData.launchAngle) with
        // default values, so SwiftData can do it lightweight.
